 ...
 */
let pp = 'https://telegra.ph/file/0a4fa7e5726f921ac52b7.jpg' //Jangan Diapus Ya Kids Nanti Eror Nangis Haha
let link = `${sgc}`
...
global.dfail = (type, m, conn) => {
    ...
    let msg = {
        rowner: `${nmsr}\n 
Feature only for _*OWNER Bot*_`,
        owner: `${nmsr}\n
Feature only for _*OWNER*_`,
        mods: `${nmsr}\n 
feature only for _*MODERATOR*_`,
        premium: `${nmsr}\n
Feature only for _*PREMIUM USER*_`,
        group: `${nmsr}\n
Feature only for _*GROUP*_`,
        private: `${nmsr}\n
Feature only for _*PRIVATE CHAT*_`,
        admin: `${nmsr}\n
Feature only for _*ADMIN*_`,
        botAdmin: `${nmsr}\n
Make the bot _*Admin*_ to use this command !`,
        nsfw: `${nmsr}\n
_*NSFW*_ is not active, please contact Team Bot Discussion to activate this feature!`,
        rpg: `${nmsr}\n
_*RPG*_ is not active, please contact Team Bot Discussion to activate this feature!`,
        restrict: `${nmsr}\n
This feature is _*DISABLED*_, try another feature`
    }[type]
     if (msg) return conn.reply(m.chat, msg, null)
        let msgg = {
    	unreg: `${nmsr}\nYou are not *registered* in our bot database, please type _*.register*_ and you can use our features.`
}[type]
if (msgg) return conn.reply(m.chat, msgg, null, m)
}    
